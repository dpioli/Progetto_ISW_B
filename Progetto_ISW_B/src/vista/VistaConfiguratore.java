...
/**
 * Classe che implementa Vista (implementazione di IVista) e implementa IVistaConfiguratore.
 * La vista del Configuratore potrebbe essere distinta da quella di altri tipi di utente.
 */
public class VistaConfiguratore extends Vista implements IVistaConfiguratore{
	...
	/**
	 * Metodo per visualizzare le proposte.
	 */
	...
	/**
	 * Metodo per andare a visualizzare l'insiemi chiusi.
	 */
